...
public class BoardMapperTest {
	...
	*/
	...
	public void insertTest() {
		...
		board.setTitle("test 제목2");
		board.setContent("test 내용2");
	...
	*/
	...
	public void deleteTest() {
		int deleteCount = mapper.delete(10L);
	...
	*/
	...
	public void updateTest() {
		BoardVO board = new BoardVO();
		board.setTitle("수정하는 제목");
		board.setContent("수정하는 내용");
		board.setWriter("수정하는 작성자");
		board.setBno(3L);
		int updateCount = mapper.update(board);
		log.info("isUpdate? : " + updateCount);
	}
